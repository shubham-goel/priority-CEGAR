...
\section{Computational complexity}
	...
	% Each clause message's path intersects exactly one of the message paths of every variable it contains, depending on whether the variable appears as a positive literal or a negative one. Clause message $m_C$'s path intersects $p_{x}$ if $x$ appears as a positive literal in $C$, similarly for $p_{\neg x}$.
